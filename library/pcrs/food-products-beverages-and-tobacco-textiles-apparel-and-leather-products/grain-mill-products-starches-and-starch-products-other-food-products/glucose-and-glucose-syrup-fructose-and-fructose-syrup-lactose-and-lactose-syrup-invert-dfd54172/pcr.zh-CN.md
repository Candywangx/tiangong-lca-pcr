...
| --- | --- |
| 参考数量 | 1 kg |
| 参考产品流 | Dextrose Monohydrate `8f56ee97-f5f8-4685-a958-74f586b40cd9`（仅为代表产品形态） |
...
- 选定流：仅实际产品匹配时使用 Dextrose Monohydrate `8f56ee97-f5f8-4685-a958-74f586b40cd9`；否则使用路线特定产品流
- 流属性/单位：Mass `93a60a56-a3c8-11da-a746-0800200b9a66` / kg
