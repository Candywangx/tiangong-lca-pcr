...
| --- | --- |
| 参考数量 | 1 kg |
| 参考产品流 | Almond `05bb565f-a834-4543-8d65-dd4029d5deea` |
...
- 选定流：产品特定分级去壳坚果；Almond `05bb565f-a834-4543-8d65-dd4029d5deea` 仅用于已确认的杏仁代表情形
- 流属性/单位：Mass `93a60a56-a3c8-11da-a746-0800200b9a66` / kg
...
- 选定流：Almond `05bb565f-a834-4543-8d65-dd4029d5deea` 仅用于杏仁代表情形；否则使用已核验产品特定流
- 流属性/单位：Mass `93a60a56-a3c8-11da-a746-0800200b9a66` / kg
