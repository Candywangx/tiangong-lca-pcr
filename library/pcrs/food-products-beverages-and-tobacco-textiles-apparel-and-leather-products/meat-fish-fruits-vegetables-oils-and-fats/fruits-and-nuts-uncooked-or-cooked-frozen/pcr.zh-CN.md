...
| --- | --- |
| 参考数量 | 1 kg 净冷冻产品 |
| 参考产品流 | 香蕉 `ce6b2d04-9b60-4b60-a4e7-553d7ae67ce0` |
...
- 选定流：适合产品的冷冻水果或坚果流；香蕉 `ce6b2d04-9b60-4b60-a4e7-553d7ae67ce0` 仅用于冷冻香蕉
- 流属性/单位：Mass `93a60a56-a3c8-11da-a746-0800200b9a66` / kg
- 数量规则：实测合格冷冻产出质量
- 数值来源模式：前景记录（`foreground_record`）
- 适用范围：产品特定（`product_specific`）
...
- 选定流：香蕉 `ce6b2d04-9b60-4b60-a4e7-553d7ae67ce0`
- 流属性/单位：Mass `93a60a56-a3c8-11da-a746-0800200b9a66` / kg
