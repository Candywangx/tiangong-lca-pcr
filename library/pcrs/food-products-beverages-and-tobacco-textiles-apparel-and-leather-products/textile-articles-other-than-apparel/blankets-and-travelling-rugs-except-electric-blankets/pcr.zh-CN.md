...
| --- | --- |
| 参考数量 | 1 kg |
| 参考产品流 | Blanket `b7478885-d1a2-4ced-9240-4737fc0b8020` |
...
- 选定流：Waste fiber fabric `cd3a2b81-3287-457e-9501-2a39f59cec99`
- 流属性/单位：Mass / kg
- 数量规则：按批次和去向实测边角料质量
- 数值来源模式：前景记录（`foreground_record`）
- 适用范围：产品特定（`product_specific`）
...
- 选定流：Liquid Detergent `c1214ed0-28a4-4273-a8c9-a4f29351747a`
- 流属性/单位：Mass / kg
...
- 选定流：Textile finishing agent `2289d57c-b3aa-4288-a69c-c0f7aa016702`
- 流属性/单位：Mass / kg
...
- 选定流：Blanket `b7478885-d1a2-4ced-9240-4737fc0b8020`
- 流属性/单位：Mass / kg
